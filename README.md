...
```sh
# From your Backstage root directory
yarn add --cwd packages/backend @dhouglasoliveira/scaffolder-backend-module-azure-pipelines
```
...
} from "@dhouglasoliveira/scaffolder-backend-module-azure-pipelines";
